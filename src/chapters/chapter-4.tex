...
\begin{longtable}[c]{|l|l|}
  \caption{Lingkungan pengujian komputer server}
  \label{tab:lingkungan-server}                                \\
  \hline
  \rowcolor{gray!30}
...
\begin{longtable}[c]{|l|l|>{\setlength{\baselineskip}{0.75\baselineskip}}p{0.5\linewidth}|}
  \caption{Kategori penilaian SOLO Level}
...
\begin{longtable}[c]{|l|>{\setlength{\baselineskip}{0.75\baselineskip}}p{0.5\linewidth}|}
  \caption{Hasil perhitungan statistik deskriptif pada respon kuesioner pertanyaan pertama}
...
\begin{longtable}[c]{|l|>{\setlength{\baselineskip}{0.75\baselineskip}}p{0.5\linewidth}|}
  \caption{Hasil perhitungan statistik deskriptif pada respon kuesioner pertanyaan kedua}
...
\begin{enumerate}
  ...
  \item Pembelajaran hanya membahas materi dasar agar dapat dipahami dan diselesaikan oleh orang awam
  \item Pembuatan materi pembelajaran tidak menggunakan tenaga kerja ahli
  \item Jumlah sampel yang sedikit
  \item Sulitnya mendapatkan peserta dengan pemahaman konsep awal yang sama rata
  \item Sampling tidak memenuhi keseluruhan demografis pengguna KodeBareng karena menggunakan teknik \textit{convenience sampling}
  \item Penilaian jawaban berdasarkan SOLO Level tidak menggunakan tenaga kerja ahli independen seperti pada eksperimen aslinya
\end{enumerate}
...
\begin{longtable}[c]{|l|l|l|l|l|l|l|}
  ...
  \multicolumn{1}{|c|}{\cellcolor[HTML]{C0C0C0}\textbf{Aspek}} & \multicolumn{1}{c|}{\cellcolor[HTML]{C0C0C0}\textbf{Sololearn}} & \multicolumn{1}{c|}{\cellcolor[HTML]{C0C0C0}\textbf{Brilliant}} & \multicolumn{1}{c|}{\cellcolor[HTML]{C0C0C0}\textbf{Flexbox Froggy}} & \multicolumn{1}{c|}{\cellcolor[HTML]{C0C0C0}\textbf{Progate}} & \multicolumn{1}{c|}{\cellcolor[HTML]{C0C0C0}\textbf{Python Tutor}} & \multicolumn{1}{c|}{\cellcolor[HTML]{C0C0C0}\textbf{KodeBareng (awal)}} \\ \hline
  \endfirsthead
  %
  ...
  \endhead
  %
  Kelas pemrograman                                            & Ada                                                             & Ada                                                             & Ada                                                                  & Ada                                                           & Tidak ada                                                          & Ada                                                                     \\ \hline
  Pembawaan materi interaktif                                  & Tidak ada                                                       & Ada                                                             & Ada                                                                  & Ada                                                           & Tidak ada                                                          & Ada                                                                     \\ \hline
  Latihan soal kode                                            & Ada                                                             & Tidak ada                                                       & Ada                                                                  & Ada                                                           & Tidak ada                                                          & Ada                                                                     \\ \hline
  Visualisasi eksekusi kode                                    & Tidak ada                                                       & Tidak ada                                                       & Tidak ada                                                            & Tidak ada                                                     & Ada                                                                & Tidak ada                                                               \\ \hline
\end{longtable}
\normalsize

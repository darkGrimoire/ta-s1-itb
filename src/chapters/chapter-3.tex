...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{chapter3/diagram_konteks.png}
  \caption{Diagram konteks} \label{fig:diagram-konteks}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{chapter3/DFD_lv1.png}
  \caption{DFD Level 1} \label{fig:dfd-lv1}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{chapter3/DFD_lv2_Frontend.png}
  \caption{DFD Level 2 - Frontend} \label{fig:dfd-lv2-frontend}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{chapter3/DFD_lv2_Backend.png}
  \caption{DFD Level 2 - Backend} \label{fig:dfd-lv2-backend}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{chapter3/DFD_lv2_Eksekutor.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{chapter3/diagram_komponen.png}
